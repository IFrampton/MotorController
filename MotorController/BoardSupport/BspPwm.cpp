...
void BspPwm::Initialize(long frequency)
{
	// Enable clocks
	SYSCON->SCTCLKSEL = 0; // Configure the PWM to be driven by the main processor clock
	SYSCON->AHBCLKCTRLX[1] |= (1 << 2); // Enable the Clock to the PWM
	SYSCON->SCTCLKDIV = 0; // Use clock frequency directly
	// Configure the PWM
	...
	// Output 4 = Low Side Switch for Phase A
	SCT0->MATCH[8] = 0; // Turn On
	SCT0->MATCH[9] = 0; // Turn Off
	// Output 5 = Low Side Switch for Phase B
	SCT0->MATCH[10] = 0; // Turn On
	SCT0->MATCH[11] = 0; // Turn Off
	// Output 6 = Low Side Switch for Phase C
	SCT0->MATCH[12] = 0; // Turn On
	SCT0->MATCH[13] = 0; // Turn Off

	// Setup Match Registers with defaults
	SCT0->MATCHREL[0] = counts;
	// This gives a 180° signal
	SCT0->MATCHREL[1] = counts >> 1;
	// Output 1 = High Side Switch for Phase A
	SCT0->MATCHREL[2] = 0; // Turn On
	SCT0->MATCHREL[3] = 0; // Turn Off
	// Output 2 = High Side Switch for Phase B
	SCT0->MATCHREL[4] = 0; // Turn On
	SCT0->MATCHREL[5] = 0; // Turn Off
	// Output 3 = High Side Switch for Phase C
	SCT0->MATCHREL[6] = 0; // Turn On
	SCT0->MATCHREL[7] = 0; // Turn Off
	// Output 4 = Low Side Switch for Phase A
	SCT0->MATCHREL[8] = 0; // Turn On
	SCT0->MATCHREL[9] = 0; // Turn Off
	// Output 5 = Low Side Switch for Phase B
	SCT0->MATCHREL[10] = 0; // Turn On
	SCT0->MATCHREL[11] = 0; // Turn Off
	// Output 6 = Low Side Switch for Phase C
	SCT0->MATCHREL[12] = 0; // Turn On
	SCT0->MATCHREL[13] = 0; // Turn Off
