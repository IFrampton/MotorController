...
class BspGpio
{
	...
	public:  static void SetupGeneric(unsigned char port, unsigned char pin, unsigned char mux, bool pullup = false, bool pulldown = false, bool analog = false, unsigned char anInput = 0);
