...
class BspCan
{
	...
	public: static void GetData(char handle, unsigned long *identifier, char *length, unsigned long *data, bool *extended, bool *error, unsigned short *timestamp);
