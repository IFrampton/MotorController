...
unsigned char BspDma::SetupTxChannel(unsigned char input, unsigned long *memSource, unsigned long *periphDest, unsigned char length)
{
	if(_nextStream <= 8)
	{
		return 255;
	...
	stream->CR = 	(0  << 23)	|	// MBURST = 0; Memory Burst Transfer Configuration (0 = Single Transfer)
					...
					(1  << 13)	|	// MSIZE = 1; Memory Data Size (1 = 16-bit)
					(1  << 11)	|	// PSIZE = 1; Peripheral Data Size (1 = 16-bit)
